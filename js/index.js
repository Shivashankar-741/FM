...
let multiplier_canvasy = canvasWireBwMultiplierToModulator.offsetTop;
...
selectors.connectionWireBwModulatorToDifferentiator.onmousemove = function (e) {
  ...
  if (modulator_WireBwModulatorToDifferentiator) {
    ...
    modulator_ctx.clearRect(
      0,
      0,
      canvasWireBwModulatorToDifferentiator.width,
      canvasWireBwModulatorToDifferentiator.height
    ); //clear canvas
...
let differentiator_canvasy = canvasWireBwDifferentiatorTodcLimiter.offsetTop;
...
selectors.check.onmousemove = function (e) {
  if (differentiator_WireBwDifferentiatorTodcLimiter) {
    ...
    differentiator_ctx.clearRect(
      0,
      0,
      canvasWireBwDifferentiatorTodcLimiter.width,
      canvasWireBwDifferentiatorTodcLimiter.height
    ); //clear canvas
...
let envelope_canvasy = canvasWireBwenvelopeDetToParamExtract.offsetTop;
...
selectors.connectionWireBwDifferentiatorTodcLimiter.onmousemove = function (e) {
  if (envelope_WireBwEnvelopeToParameterExtraction) {
    ...
    envelope_ctx.clearRect(
      0,
      0,
      canvasWireBwenvelopeDetToParamExtract.width,
      canvasWireBwenvelopeDetToParamExtract.height
    ); //clear canvas
...
let dcLimiter_canvasy = canvasWireBwdcLimiterToEnvelopeDetector.offsetTop;
...
selectors.check2.onmousemove = function (e) {
  if (dcLimiter_WireBwdcLimiterToEnvelopeDetector) {
    ...
    dcLimiter_ctx.clearRect(
      0,
      0,
      canvasWireBwdcLimiterToEnvelopeDetector.width,
      canvasWireBwdcLimiterToEnvelopeDetector.height
    ); //clear canvas
...
selectors.modulator.onmouseup = () => {
  ...
  modulator.onclick = () => {
    ...
    if (selectors.model.value === 'Delete') {
      ...
      if (
        freqSen_isWireConnected &&
        integrator_isWireConnected &&
...
selectors.envelopeDetector.onmouseup = () => {
  ...
  envelopeDetector.onclick = () => {
    ...
    if (selectors.model.value === 'Delete') {
      ...
      if (
        differentiator_isWireConnected &&
        modulator_isWireConnected &&
        freqSen_isWireConnected &&
        integrator_isWireConnected &&
        modSig_isWireConnected &&
